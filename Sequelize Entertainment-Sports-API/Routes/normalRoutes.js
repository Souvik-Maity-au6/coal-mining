...
const {searchTheater,getAllMovies, getSingleMovie,verify,resendEmail,resetPassword, 
    ...
    searchTheaterByCity,searchTheaterByAvailableScreen,getShowTiming,searchSingleTvSeries,
    searchUpcomingTvSeries,searchCurrentTvSeries,searchCityEvents,searchSports,searchCitySports} = require("../Controller/normalController");
const router = Router();
